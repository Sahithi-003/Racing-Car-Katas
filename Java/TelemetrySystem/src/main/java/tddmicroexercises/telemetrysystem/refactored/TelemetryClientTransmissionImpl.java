...
public class TelemetryClientTransmissionImpl implements TelemetryClientTransmission {
private final TelemetryClient telemetryClient;

    public TelemetryClientTransmissionImpl(TelemetryClient telemetryClient) {
